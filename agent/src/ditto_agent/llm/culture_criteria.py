...
CULTURE_CRITERIA: list[CriteriaRow] = [
    {
        ...
        "direction": "양방향",
        "phrase": "내일까지 부탁드려요",
        "reason": "발신자/수신자 시간대 기준 불명확 — 설문(n=14)에서 발신자기준/수신자기준/24시간이내 세 후보가 실제로 갈림",
    ...
    },
    {
        ...
        "direction": "양방향",
        "phrase": "빠른 시일 내로",
        "reason": "상대적 표현, 구체적 기한 없음 — 설문에서 재확인 필요성 응답이 5.4/7로 높음",
    ...
    },
    {
        ...
        "direction": "양방향",
        "phrase": "가능하면 오늘 중으로",
        "reason": "'가능하면'이 우선순위를 낮추는지 실제 마감인지 모호 — 설문에서 우선순위 불명확 경험 응답이 6.4/7로 최고치",
    ...
    },
    {
        ...
        "direction": "양방향",
        "phrase": "이번 주 중으로",
        "reason": "요일 범위가 넓어 실제 작업 착수 시점 예측 어려움 — 설문에서 두 후보가 5.3 vs 5.1로 거의 완전히 갈려 T축 중 가장 강한 모호성",
    ...
    },
    {
        ...
        "direction": "양방향",
        "phrase": "곧 다시 연락드릴게요",
        "reason": "'곧'의 기준(시간 단위)이 문화/개인마다 상이 — 설문에서 후보 3개(1~2시간/당일중/다음영업일)가 비슷하게 갈림",
    ...
    },
    {
        ...
        "reason": "발신자 의도(현재 안 재검토 요청 · 완곡한 반대)와 수신자 해석(긍정 평가 + 선택적 제안) 사이 간극 — 설문에서 실제로 갈림(3.5 vs 4.4)",
    ...
    },
    {
        ...
        "reason": "팀 차원의 우려 전달인지, 근거 없는 동조 압박으로 읽힐지 모호 — 설문에서 실제로 갈림(4.5 vs 2.9)",
        "candidates": ["구체적 인원·근거를 명시한 우려 전달", "화자 개인 의견을 팀 의견으로 일반화"],
    ...
    },
    {
        ...
        "direction": "KR→US",
        "phrase": "괜찮은 것 같아요, 근데...",
        "reason": "국내 화자는 '근데' 이후가 핵심이라는 걸 이미 강하게 알아챔(설문 5.5/7) — 다만 발신자가 다른 조직 관행에 익숙하면 이 구조를 안 쓸 수도 있어 확인은 여전히 유효",
    ...
    },
    {
        ...
        "reason": "국내 수신자는 X를 '반드시 고쳐야 할 필수 사항'으로 거의 만장일치 해석(설문 6.1/7, sd 0.77) — 원어민 발신자의 실제 의도(문헌상 완곡한 참고)와 격차가 클 수 있어 확인이 특히 중요",
    ...
    },
    {
        ...
        "reason": "업무적 반대 표현이 개인적 감정 신호나 관계 악화로 오해될 수 있음 — 설문에서 실제로 갈림(3.9 vs 3.5)",
        "candidates": ["업무적 반대(관계와 무관)", "강한 불만 · 관계 이슈로 인식될 위험"],
    ...
    },
    {
        ...
        "reason": "이해를 위한 질문인지, 결정에 대한 추궁으로 읽힐지 모호 — 설문에서 순수질문 쪽이 약우세하나(4.7 vs 2.9) 격차가 크지 않음",
        "candidates": ["이해를 돕기 위한 질문", "결정에 대한 불신 · 재검토 요구로 해석될 위험"],
    ...
    },
    {
        ...
        "direction": "양방향",
        "phrase": "일단 이렇게 진행해봐요",
        "reason": "국내에서는 '1차 시도'로 강하게 수렴하지만(설문 6.4/7), 조직마다 '일단'의 무게감이 달라 상대 조직 기준과 어긋날 수 있음",
    ...
    },
    {
        ...
        "reason": "조직마다 '완료'의 의미가 다름(최종 승인 vs 1차 검토) — 설문에서도 국내 응답자 사이에서 실제로 가장 크게 갈림(3.0 vs 5.0)",
    ...
    },
    {
        ...
        "direction": "양방향",
        "phrase": "확인했습니다",
        "reason": "국내에서는 '수신 확인'으로 강하게 수렴하지만(설문 5.9/7), 조직을 옮기면 '확인'의 무게감이 달라질 수 있음",
    ...
    },
    {
        ...
        "direction": "양방향",
        "phrase": "이견 없습니다",
        "reason": "적극 동의 vs 소극적 무이의 구분 안 됨 — 설문에서 실제로 갈림(3.7 vs 4.3)",
    ...
    },
    {
        ...
        "direction": "양방향",
        "phrase": "나중에 다시 얘기해요",
        "reason": "국내에서는 '시점 미정 보류'로 강하게 수렴하지만(설문 6.1/7), 실제로 완곡한 거절이었던 경험도 중간 이상(4.2/7) — 기본 해석과 실제 의도 사이 간극이 위험",
